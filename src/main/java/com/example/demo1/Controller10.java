...
public class Controller10 {
    ...
    void initialize() {
        try {
            ...
            System.out.println(Controller.getS());
            ...
            while(result.next()){
                if (result.getString(Const.USERS_LOGIN).equals(Controller.getS()) && result.getString(Const.USERS_PASSWORD).equals(Controller.getP())){
            ...
            superuser.setText(msg.toString());
